...
const secretman = __importStar(__nccwpck_require__(4552));
const validators_1 = __nccwpck_require__(6185);
function trimSlashes(str) {
    return str.replace(/^\/+|\/+$/g, '');
}
function getStr(str) {
    var _a;
    return (_a = (str || '')) === null || _a === void 0 ? void 0 : _a.toString();
}
function setSecret(key, value) {
    core.exportVariable(key, value);
    core.setOutput(key, value);
}
function getSecret(hostname, apiKey, key) {
    return __awaiter(this, void 0, void 0, function* () {
        core.info(`Getting Secret for ${key} from ${hostname}`);
        const response = yield secretman.generateSecret(hostname, key, apiKey).catch((err) => {
...
function getAndSetSecrets(hostname, apiKey, secretKeys) {
    return __awaiter(this, void 0, void 0, function* () {
        const p = secretKeys === null || secretKeys === void 0 ? void 0 : secretKeys.split(',').map((key) => key.trim()).map((key) => __awaiter(this, void 0, void 0, function* () { return getSecret(hostname, apiKey, key); }));
        yield Promise.all(p);
    });
}
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const hostname = core.getInput('pam_hostname', { required: true });
            const apiKey = core.getInput('api_key', { required: true });
            const secretKeys = core.getInput('pam_secret_keys', { required: true });
            core.info('Validating inputs...');
            if (!(0, validators_1.isValidUrl)(hostname)) {
                throw TypeError('input provided for hostname not in expected format');
            }
            yield getAndSetSecrets(trimSlashes(hostname), getStr(apiKey), getStr(secretKeys));
        }
        catch (error) {
...
const PRIME = '';
...
function generateSecret(hostName, secretKey, apiKey) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { data: responseData } = yield axios.default.get(settings.url, { headers: settings.headers });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.generateSecret = void 0;
var generate_secret_1 = __nccwpck_require__(345);
Object.defineProperty(exports, "generateSecret", ({ enumerable: true, get: function () { return generate_secret_1.generateSecret; } }));
